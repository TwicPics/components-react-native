...
| `mode` | Can be `center`, `contain`, `cover`, `repeat` or `stretch` and determines how image fills the area. See the [React Native documentation](https://reactnative.dev/docs/image#resizemode). | `String` | `cover` |
...
[npm-image]: https://img.shields.io/badge/npm-v0.0.1--alpha.4-orange.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@twicpics/components-react-native/v/0.0.1-alpha.4
